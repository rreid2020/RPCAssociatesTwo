...
const STATEMENTS = [
  ...
  provincial_elections_canadian_citizen BOOLEAN,
  provincial_elections_authorize BOOLEAN,
  ...
  'ALTER TABLE taxgpt.taxpayer_profiles ADD COLUMN IF NOT EXISTS provincial_elections_canadian_citizen BOOLEAN',
  'ALTER TABLE taxgpt.taxpayer_profiles ADD COLUMN IF NOT EXISTS provincial_elections_authorize BOOLEAN',
