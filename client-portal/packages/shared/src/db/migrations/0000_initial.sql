...
-- Add foreign keys
DO $$ BEGIN
 ALTER TABLE "documents" ADD CONSTRAINT "documents_source_id_sources_id_fk" FOREIGN KEY ("source_id") REFERENCES "sources"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
...
CREATE INDEX IF NOT EXISTS "sources_ingest_status_idx" ON "sources" ("ingest_status");
