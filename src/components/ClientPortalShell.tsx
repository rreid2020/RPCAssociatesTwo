            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-text-light hover:bg-background"
                >
                  {user?.imageUrl ? (
                    <img
                      src={user.imageUrl}
                  ...
                  <span className="hidden md:block">{user?.fullName || user?.emailAddresses?.[0]?.emailAddress || 'User'}</span>
                </button>
              </div>
            </div>
          </div>
