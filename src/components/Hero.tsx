      ...
      <div className="max-w-[1200px] mx-auto px-md">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-xxl items-center">
          <div className="max-w-[600px]">
            <div className="inline-block text-sm font-semibold text-primary uppercase tracking-wider mb-md">Accounting · Consulting · Tech Solutions</div>
          ...
          <div className="bg-white p-xl rounded-xl shadow-md">
            ...
            <ul className="list-none">
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-primary before:font-bold">Better decisions backed by accurate numbers</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-primary before:font-bold">More time to focus on operations and growth</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-primary before:font-bold">Improved compliance and reduced risk</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-primary before:font-bold">Stronger cash flow and long-term planning</li>
            </ul>
          </div>
        </div>
      </div>
