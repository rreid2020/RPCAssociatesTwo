        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-xxl items-center">
          ...
          <div className="bg-white p-xl rounded-xl shadow-md">
            ...
            <ul className="list-none">
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-accent before:font-bold">Better decisions backed by accurate numbers</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-accent before:font-bold">More time to focus on operations and growth</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-accent before:font-bold">Improved compliance and reduced risk</li>
              <li className="pl-md mb-sm relative before:content-['✓'] before:absolute before:left-0 before:text-accent before:font-bold">Stronger cash flow and long-term planning</li>
            </ul>
          </div>
        </div>
      </div>
