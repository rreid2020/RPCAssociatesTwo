    ...
    <>
      ...
      <main>
        <MarketingPageHero
          ...
          lede="Having adequate cash flow is essential to keep your business running. Use this calculator to help determine the cash flow generated by your business."
          primary={(
          ...
          strip={['Operating · Investing · Financing', 'Free tool', 'Planning only']}
        />
        ...
        <div className="svc-landing">
          <section className="closing" id="closing">
            <div className="wrap">
              ...
              <p className="lede">
                Our team can help you improve cash flow, create forecasts, and maintain healthy liquidity.
              </p>
