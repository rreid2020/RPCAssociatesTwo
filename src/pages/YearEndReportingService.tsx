    ...
    <>
      ...
      <main className="ye-page">
        <style>{`
          ...
          .ye-page * { box-sizing: border-box; }
          .ye-page .wrap { max-width: var(--maxw); margin-inline: auto; padding-inline: 24px; }
          .ye-page section { padding-block: 64px; border-top: 1px solid var(--rule); }
          .ye-page section:first-of-type { border-top: 0; }
          .ye-page .alt { background: var(--paper-alt); }
          .ye-page h1, .ye-page h2, .ye-page h3 {
            font-family: var(--font-display); font-weight: 600; line-height: 1.2; color: var(--navy); margin: 0 0 .5em;
          }
          .ye-page h1 { font-size: clamp(2rem, 4.4vw, 3rem); letter-spacing: -.01em; }
          .ye-page h2 { font-size: clamp(1.5rem, 3vw, 2rem); }
          .ye-page h3 { font-size: 1.075rem; font-family: var(--font); font-weight: 650; line-height: 1.35; }
          .ye-page p { margin: 0 0 1em; }
          .ye-page p:last-child { margin-bottom: 0; }
          .ye-page a { color: var(--accent); }
          .ye-page .eyebrow {
            font-size: .75rem; font-weight: 700; letter-spacing: .14em; text-transform: uppercase;
            color: var(--accent); margin: 0 0 14px;
          }
          .ye-page .lede { font-size: 1.2rem; line-height: 1.55; color: var(--ink-muted); max-width: 62ch; }
          .ye-page .intro { max-width: 72ch; }
          .ye-page .section-note { font-size: .95rem; color: var(--ink-muted); max-width: 72ch; }
          .ye-page .hero { background: var(--navy); color: #dbe6f2; border-top: 0; }
          .ye-page .hero h1 { color: #fff; max-width: 20ch; }
          .ye-page .hero .eyebrow { color: #7fc7cf; }
          .ye-page .hero .lede { color: #c2d3e4; }
          .ye-page .hero strong { color: #fff; }
          .ye-page .strip {
            margin-top: 34px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,.22);
            font-size: .92rem; color: #9fbdd8; letter-spacing: .02em;
          }
          .ye-page .strip b { color: #fff; font-weight: 600; }
          .ye-page .cta-row { display: flex; flex-wrap: wrap; gap: 14px; margin-top: 32px; }
          .ye-page .btn {
            display: inline-block; padding: 13px 24px; border-radius: var(--radius); font-weight: 650;
          ...
          .ye-page .btn-primary { background: #fff; color: var(--navy); border-color: #fff; }
          .ye-page .btn-primary:hover { background: #e9f3f4; color: var(--navy); }
          .ye-page .btn-ghost { background: transparent; color: #fff; border-color: rgba(255,255,255,.55); }
          .ye-page .btn-ghost:hover { border-color: #fff; color: #fff; }
          .ye-page .btn-solid { background: var(--navy); color: #fff; border-color: var(--navy); }
          .ye-page .btn-solid:hover { background: var(--navy-800); color: #fff; }
          .ye-page .btn-outline { background: transparent; color: var(--navy); border-color: var(--navy); }
          .ye-page .btn-outline:hover { background: var(--navy-050); color: var(--navy); }
          .ye-page .btn-sm { padding: 10px 20px; font-size: .92rem; }
          .ye-page .pairs { margin-top: 44px; }
          .ye-page .pairrow {
            display: grid; gap: 28px; grid-template-columns: 1fr 1fr;
            padding: 30px 0; border-top: 1px solid var(--rule);
          }
          .ye-page .pairrow:first-child { border-top: 0; padding-top: 6px; }
          .ye-page .label {
            font-size: .7rem; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin: 0 0 10px;
          }
          .ye-page .label-problem { color: var(--flag); }
          .ye-page .label-do { color: var(--accent); }
          .ye-page .side-problem h3 { color: var(--flag); }
          .ye-page .side-do { border-left: 3px solid var(--accent); padding-left: 22px; }
          .ye-page .pairrow p { font-size: .97rem; color: var(--ink-muted); }
          .ye-page .offer {
            margin-top: 36px; display: grid; gap: 0; grid-template-columns: 1.55fr 1fr;
            border: 1px solid var(--rule); border-radius: var(--radius); overflow: hidden; background: var(--paper);
          }
          .ye-page .offer-main { padding: 32px 34px; }
          .ye-page .offer-side {
            padding: 32px 30px; background: var(--navy); color: #c2d3e4;
            display: flex; flex-direction: column; justify-content: center;
          }
          .ye-page .offer-side .k {
            font-size: .7rem; letter-spacing: .13em; text-transform: uppercase; color: #7fc7cf;
            font-weight: 700; margin-bottom: 8px;
          }
          .ye-page .offer-side .price {
            font-family: var(--font-display); font-size: 2.3rem; color: #fff; line-height: 1; margin-bottom: 14px;
          }
          .ye-page .offer-side p { font-size: .9rem; color: #a9c2da; }
          .ye-page .offer-side .btn { margin-top: 20px; align-self: flex-start; }
          .ye-page .checklist { list-style: none; margin: 18px 0 0; padding: 0; }
          .ye-page .checklist li {
            position: relative; padding-left: 28px; margin-bottom: 12px; font-size: .97rem; color: var(--ink);
          }
          .ye-page .checklist li:last-child { margin-bottom: 0; }
          .ye-page .checklist li::before {
            content: ""; position: absolute; left: 2px; top: .55em;
            width: 10px; height: 10px; border-radius: 2px; background: var(--accent);
          }
          .ye-page .guarantees {
            list-style: none; margin: 36px 0 0; padding: 0; display: grid; gap: 18px;
            grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));
          }
          .ye-page .guarantees li {
            background: var(--paper); border: 1px solid var(--rule); border-top: 3px solid var(--accent);
            border-radius: var(--radius); padding: 24px;
          }
          .ye-page .guarantees h3 { color: var(--accent); margin-bottom: .45em; }
          .ye-page .guarantees p { font-size: .95rem; color: var(--ink-muted); margin: 0; }
          .ye-page .tiers {
          ...
          .ye-page .tier-featured {
            border-color: var(--navy); border-width: 2px; box-shadow: 0 2px 16px rgba(0,32,74,.08);
          }
          .ye-page .tier .name {
          ...
          .ye-page .tier .price {
            font-family: var(--font-display); font-size: 2.1rem; color: var(--navy); line-height: 1; margin-bottom: 6px;
          }
          .ye-page .tier .unit { font-size: .85rem; color: var(--ink-muted); margin-bottom: 8px; }
          .ye-page .tier .turn { font-size: .85rem; font-weight: 650; color: var(--accent); margin-bottom: 16px; }
          .ye-page .tier .who {
            font-size: .93rem; color: var(--ink-muted); padding-bottom: 18px; margin-bottom: 18px;
            border-bottom: 1px solid var(--rule);
          }
          .ye-page .tier ul { list-style: none; margin: 0 0 24px; padding: 0; flex: 1; }
          .ye-page .tier li {
            position: relative; padding-left: 20px; margin-bottom: 9px; font-size: .93rem; color: var(--ink);
          }
          .ye-page .tier li::before {
            content: ""; position: absolute; left: 0; top: .6em; width: 7px; height: 7px;
            border-radius: 50%; background: var(--accent);
          }
          .ye-page .tier li.carry { color: var(--ink-muted); font-weight: 600; }
          .ye-page .tier .btn { align-self: flex-start; }
          .ye-page .limits {
            display: grid; gap: 26px; grid-template-columns: repeat(auto-fit, minmax(310px, 1fr)); margin-top: 36px;
          }
          .ye-page .limits h3 {
            color: var(--flag); font-size: 1.05rem; padding-bottom: 10px; border-bottom: 2px solid var(--flag-050);
          }
          .ye-page .limits ul { margin: 16px 0 0; padding-left: 1.15em; }
          .ye-page .limits li { margin-bottom: .75em; font-size: .95rem; color: var(--ink-muted); }
          .ye-page .limits li:last-child { margin-bottom: 0; }
          .ye-page .panel {
            margin-top: 38px; padding: 26px 28px; border-radius: var(--radius);
            background: var(--flag-050); border: 1px solid #e6d3ac;
          }
          .ye-page .panel h3 { color: var(--flag); font-size: 1.05rem; }
          .ye-page .panel-accent { background: var(--accent-050); border-color: #b9d9dc; }
          .ye-page .panel-accent h3 { color: var(--accent); }
          .ye-page .panel p { font-size: .95rem; }
          .ye-page .panel ul { margin: 16px 0 0; padding-left: 1.15em; }
          .ye-page .panel li { margin-bottom: .7em; font-size: .95rem; color: var(--ink); }
          .ye-page .panel li:last-child { margin-bottom: 0; }
          .ye-page .panel li strong { color: var(--ink); }
          .ye-page .steps { list-style: none; counter-reset: step; margin: 36px 0 0; padding: 0; }
          .ye-page .steps > li {
            counter-increment: step; position: relative; padding: 0 0 30px 66px;
            border-left: 2px solid var(--rule); margin-left: 20px;
          }
          .ye-page .steps > li:last-child { border-left-color: transparent; padding-bottom: 0; }
          .ye-page .steps > li::before {
            content: counter(step); position: absolute; left: -21px; top: -4px; width: 40px; height: 40px;
            border-radius: 50%; background: var(--navy); color: #fff; font-weight: 700; font-size: 1rem;
            display: grid; place-items: center;
          }
          .ye-page .steps h3 { margin-bottom: .35em; }
          .ye-page .steps p { font-size: .97rem; color: var(--ink-muted); }
          .ye-page .faq { margin-top: 36px; border-top: 1px solid var(--rule); }
          .ye-page .faq details { border-bottom: 1px solid var(--rule); }
          .ye-page .faq summary {
          ...
          .ye-page .faq summary::-webkit-details-marker { display: none; }
          .ye-page .faq summary::after {
            content: "+"; position: absolute; right: 8px; top: 15px; font-size: 1.5rem;
            font-weight: 400; color: var(--accent); line-height: 1;
          }
          .ye-page .faq details[open] summary::after { content: "\\2013"; }
          .ye-page .faq summary:focus-visible { outline: 2px solid var(--accent); outline-offset: 3px; }
          .ye-page .faq .a { padding: 0 44px 22px 0; color: var(--ink-muted); font-size: .98rem; max-width: 80ch; }
          .ye-page .closing { background: var(--navy-050); text-align: center; }
          .ye-page .closing .lede { margin-inline: auto; }
          .ye-page .closing .cta-row { justify-content: center; }
          @media (max-width: 760px) {
            .ye-page .pairrow { grid-template-columns: 1fr; gap: 22px; }
            .ye-page .side-do { padding-left: 18px; }
            .ye-page .offer { grid-template-columns: 1fr; }
          }
          @media (max-width: 640px) {
            .ye-page { font-size: 16px; }
            .ye-page section { padding-block: 48px; }
            .ye-page .steps > li { padding-left: 56px; }
            .ye-page .offer-main, .ye-page .offer-side { padding: 26px 22px; }
          }
        `}</style>
